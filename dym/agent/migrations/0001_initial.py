    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='Enter a valid email address.', max_length=100, null=True, validators=[django.core.validators.EmailValidator()], verbose_name='Email')),
                ('phone', models.CharField(blank=True, help_text='Phone number in international format, e.g. +420123456789.', max_length=20, null=True, validators=[django.core.validators.RegexValidator(message='Enter a valid phone number (e.g. +420123456789).', regex='^\\+?\\d{9,15}$')], verbose_name='Phone')),
            ],
            options={
                'verbose_name': 'Person',
