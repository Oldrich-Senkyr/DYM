...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        file_path = os.path.join(settings.BASE_DIR, 'dym', 'locale', 'cs', 'LC_MESSAGES', input_filename)
        ...
        try:
            ...
            if matches:
                ...
                output_path = os.path.join(settings.BASE_DIR, 'dym', 'locale', 'cs', 'LC_MESSAGES', output_filename)
