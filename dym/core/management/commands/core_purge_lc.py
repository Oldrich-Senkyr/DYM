...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        file_path = os.path.join(settings.BASE_DIR, 'core', 'locale', 'cs', 'LC_MESSAGES', input_filename)
        ...
        try:
            ...
            output_path = os.path.join(settings.BASE_DIR, 'core', 'locale', 'cs', 'LC_MESSAGES', output_filename)
